document.addEventListener("DOMContentLoaded", function() {
    ...
    var bookingStatus = getUrlParameter('booking');
    var errorMessages = getUrlParameter('errors');
    
    // If there's a booking status parameter
    if (bookingStatus) {
        ...
        if (bookingStatus === 'success') {
            ...
            messageContainer.innerHTML = '<i class="ti-check"></i> Your booking request has been sent successfully! We will contact you soon.';
        } else if (bookingStatus === 'error') {
            messageContainer.style.backgroundColor = '#f8d7da';
            messageContainer.style.color = '#721c24';
            messageContainer.style.border = '1px solid #f5c6cb';
            messageContainer.innerHTML = '<i class="ti-alert"></i> There was a problem sending your request. Please try again later.';
        } else if (bookingStatus === 'validation') {
